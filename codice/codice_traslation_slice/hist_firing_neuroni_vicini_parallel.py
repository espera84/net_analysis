...
def plot_prerdecessori(id,n_pred):
    ...
    fig.write_html(results_path + "hist_min_" + str(min_spk) + "_min_neu_Xb_" + str(
        neu_min_per_blocco_to_plot) + "voxel_" + str(
        posizioni_centri[id_center[block_plotted[id]], :]) + "_and_pred.html")
    fig_norm.write_html(results_path + "hist_min_" + str(min_spk) + "_min_neu_Xb_" + str(
        neu_min_per_blocco_to_plot) + "voxel_" + str(
        posizioni_centri[id_center[block_plotted[id]], :]) + "_and_pred_normalized.html")
    fig3.write_html(results_path + "positions_min_" + str(min_spk) + "_min_neu_Xb_" + str(
        neu_min_per_blocco_to_plot) + "voxel_" + str(
        posizioni_centri[id_center[block_plotted[id]], :]) + "_and_pred_pyr.html")
    fig4.write_html(results_path + "positions_min_" + str(min_spk) + "_min_neu_Xb_" + str(
        neu_min_per_blocco_to_plot) + "voxel_" + str(
...
results_path=results_path+"area_activity_dist_cent_"+str(bin_x)+"_voxel_sl_"+str(distanza_massima*2)+"/"
try:
    os.mkdir(results_path)
except FileExistsError:
    pass
...
try:
    with open(results_path + 'info_firing_per_area_dist_max_' + str(distanza_massima) +'_dist_cent_'+str(bin_x)+'.pkl', 'rb') as f:
    ...
    with open(results_path+'info_firing_per_area_dist_max_'+str(distanza_massima)+'_dist_cent_'+str(bin_x)+'.pkl', 'wb') as f:  # Python 3: open(..., 'wb')
...
fig7.write_html(results_path + "prominence_min_" + str(min_spk) + "_min_neu_Xb_" + str(
...
fig8.write_html(results_path + "phase_min_" + str(min_spk) + "_min_neu_Xb_" + str(
        neu_min_per_blocco_to_plot) + modality+".html")
...
#                       )
#
# fig9.write_html(results_path + "prominence_min_" + str(min_spk) + "_min_neu_Xb_" + str(
