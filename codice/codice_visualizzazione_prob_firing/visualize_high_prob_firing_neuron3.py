...
color_discrete_sequence = ["orange", "red","red", "green","green", "blue", "blue", "pink", "pink","yellow","yellow","olive","springgreen","purple","moccasin","orange","mediumblue", "mediumorchid", "mediumpurple","saddlebrown", "salmon", "sandybrown"," paleturquoise"]
for n in range(1,10):
    print(n)
    ...
    posizioni=f_pos[pos_neuron_list[10]][aux[:] - 1, 1:]
