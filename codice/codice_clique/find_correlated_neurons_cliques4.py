...
perc_corr = sim_conf['percentual_of_different_bins_for_correlation']
...
n_neuroni=sim_conf['n_of_neurons_in_the_network']
...
try:
    ...
    fig.write_html(results_sub_path + "trasp_raster_.html")
    ...
    fig3.write_html(results_sub_path + "tn.html")
    ...
    fig3.write_html(results_sub_path + "trasp_tn.html")
